...
const IconNote = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 200 200" fill="currentColor">
    <path d="M100 0C44.8 0 0 44.8 0 100s44.8 100 100 100 100-44.8 100-100S155.2 0 100 0zm35.2 138.4c0 3.2-2.4 5.6-5.6 5.6h-12c-2.4 0-4.8-1.6-5.6-4l-20-44v42.4c0 3.2-2.4 5.6-5.6 5.6H74.4c-3.2 0-5.6-2.4-5.6-5.6V61.6c0-3.2 2.4-5.6 5.6-5.6h12c2.4 0 4.8 1.6 5.6 4l20 44V61.6c0-3.2 2.4-5.6 5.6-5.6h12c3.2 0 5.6 2.4 5.6 5.6v76.8z"/>
  </svg>
)
